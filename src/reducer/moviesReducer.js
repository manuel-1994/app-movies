const moviesInitialState = [{
  ...
  gender: ["Acción", "Aventura", "Suspense", "Bélica"],
  image:{
...
},
{
  ...
  numberOfReviews:0,
  director: "Jon Watts",
  gender: ["Acción", "Aventura", "Ciencia ficción"],
  image:{
...
},
{
  ...
  gender: ["Animación", "Comedia", "Familia", "Fantasía"],
  image:{
...
},
{
  ...
  gender: ["Animación", "Familia", "Fantasía", "Comedia", "Aventura"],
  image:{
    ...
    case 'addStars':
      return state.map(movie=>{
        if(movie.id === id){
          return {
            ...movie,
            stars: movie.stars + parseInt(stars),
            numberOfReviews: movie.numberOfReviews + 1
          }
        }
        return movie;
      })
